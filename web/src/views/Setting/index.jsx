          ...
          <Box sx={{ width: '100%' }}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
              <Tabs value={value} onChange={handleChange} variant="scrollable" scrollButtons="auto">
                ...
                <Tab label="邀请码管理" {...a11yProps(2)} icon={<IconWorldCog />} iconPosition="start" />
                <Tab label={t('setting_index.otherSettings.title')} {...a11yProps(3)} icon={<IconWorldCog />} iconPosition="start" />
              </Tabs>
            </Box>
